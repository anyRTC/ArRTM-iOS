...
/**
 用于设置或获取文件消息属性的接口类，可用于点对点或频道消息。 继承自 ARtmMessage 接口类。
 */
__attribute__((visibility("default"))) @interface ARtmFileMessage: ARtmMessage
...
**NOTE**
 thumbnail 和 fileName 加起来的大小不得超过 32 KB。
 */
...
/**
 用于设置或获取图片消息属性的接口类，可用于点对点或频道消息。 继承自 ARtmMessage 接口类。
 */
__attribute__((visibility("default"))) @interface ARtmImageMessage: ARtmMessage
...
/**
 用于维护文件上传下载比率的接口类。
 */
__attribute__((visibility("default"))) @interface ARtmMediaOperationProgress: NSObject
