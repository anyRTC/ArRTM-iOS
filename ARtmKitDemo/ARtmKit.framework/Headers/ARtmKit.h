...
/**
Returns the result of the [setLocalUserAttributes]([ARtmKit setChannel:Attributes:Options:completion:]) <p><li><i>errorCode:</i> See ARtmProcessAttributeErrorCode.
*/
typedef void (^ARtmSetChannelAttributesBlock)(ARtmProcessAttributeErrorCode errorCode);

/**
Returns the result of the [addOrUpdateChannelAttributes]([ARtmKit addOrUpdateChannel:Attributes:Options:completion:]) method call. <p><li><i>errorCode:</i> See ARtmProcessAttributeErrorCode.
*/
typedef void (^ARtmAddOrUpdateChannelAttributesBlock)(ARtmProcessAttributeErrorCode errorCode);

/**
Returns the result of the [deleteChannelAttributesByKeys]([ARtmKit deleteChannel:AttributesByKeys:Options:completion:]) method call. <p><li><i>errorCode:</i> ARtmProcessAttributeErrorCode.
*/
typedef void (^ARtmDeleteChannelAttributesBlock)(ARtmProcessAttributeErrorCode errorCode);

/**
Returns the result of the [clearChannelAttributesWithCompletion]([ARtmKit clearChannel:Options:AttributesWithCompletion:]) method call. <p><li><i>errorCode:</i> See ARtmProcessAttributeErrorCode.
*/
typedef void (^ARtmClearChannelAttributesBlock)(ARtmProcessAttributeErrorCode errorCode);

/**
 Returns the result of the [getChannelAttributes]([ARtmKit getChannelAllAttributes:completion:]) or the [getChannelAttributesByKeys]([ARtmKit getChannelAttributes:ByKeys:completion:]) method call. <p><li><i>attributes:</i> An array of ARtmChannelAttibute. See ARtmChannelAttibute. <p><li><i>errorCode:</i> See ARtmProcessAttributeErrorCode.
 */
 ...
 * errorCode: 通过 ARtmGetMembersBlock 回调返回获取频道内用户列表的结果，详见 ARtmGetMembersErrorCode 。
*/
...
/**
 ...
 @param completionBlock ARtmUnsubscriptionRequestBlock 回调返回方法调用的结果。
 */
