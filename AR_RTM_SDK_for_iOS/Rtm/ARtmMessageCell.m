...
- (void)initializeMessage{
    ...
    _nameLabel.font = [UIFont fontWithName:@"PingFang SC" size:8];;
    ...
    _infoLabel.font = [UIFont fontWithName:@"PingFang SC" size:17];
...
- (void)setMessageModel:(ARtmMessageModel *)messageModel {
    ...
    _nameLabel.text = messageModel.uid;
    //富文本
    CGFloat lineSpace = 3.0;
    NSNumber *textLengthSpace  = @0.25;
    NSDictionary *attribute = [self setTextLineSpaceWithString:messageModel.content withFont:[UIFont fontWithName:@"PingFang SC" size:16] withLineSpace:lineSpace  withTextlengthSpace:textLengthSpace paragraphSpacing:0];
